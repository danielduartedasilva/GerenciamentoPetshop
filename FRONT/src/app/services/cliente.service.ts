...
export class ClienteService {
  ...
  procurarClientePorID(id:string): Observable<Cliente>{
    return this.http.get<Cliente>(`${this.baseUrl}cliente/listar/${id}`); // ----------------------------equivalente a let url = "http://localhost:3000/" + "cliente/listar/";
  }
